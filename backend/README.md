...
## Project Structure
    ...
    ├── fm_routemanagement_30541  # Django project configurations
...
1. Clone this repo and `cd fm_routemanagement_30541`
...
2. Clone this repo and `cd fm_routemanagement_30541`
